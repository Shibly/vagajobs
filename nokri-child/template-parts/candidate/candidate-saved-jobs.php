...
<div class="main-body dashboard-title">
    <h4><?php echo esc_html__( 'Saved Jobs', 'nokri' ); ?></h4>
</div>


<div class="main-body dashboard-job-filters no-bottom-padding">
    <div class="row">
        <div class="col-md-5 col-xs-12 col-sm-4">
            ...
            <form role="search"  id="sav_job_search" method="get" class="searchform ">
             <input type="hidden" name="candidate-page" value="saved-jobs" >
                ...
                <a href="javascript:void(0)" class="a-btn no-top search_job"><i class="fa fa-search"></i></a>
