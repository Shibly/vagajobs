...
$cand_availability = get_user_meta($user_crnt_id, 'cand_availability', true);
$cand_availability_end = get_user_meta($user_crnt_id, 'cand_availability_end', true);
...
<form id="candidate-profile" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <!-- Candidate Required Informations -->
    <div class="main-body">
        <div class="dashboard-edit-profile">
            
            <div class="dashboard-title bottom-margin">
                <h4><?php echo esc_html__( 'Required Information', 'nokri' ); ?></h4>
                <p>This information is required for your profile to be complete.</p>
            </div>
                ...
                <?php if (nokri_feilds_operat('cand_phone_setting', 'show')) { ?>
                    <div class="col-md-6 col-xs-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" data-parsley-error-message="<?php echo esc_html__('Should be in digits', 'nokri'); ?>" <?php echo nokri_feilds_operat('cand_phone_setting', 'required'); ?> value="<?php echo get_user_meta($user_crnt_id, '_sb_contact', true); ?>"  name="cand_phone" id="cand_phone" class="form-control" placeholder="<?php echo nokri_feilds_label('cand_phone_plc', esc_html__('Contact number without space', 'nokri')); ?>">
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php } if (nokri_feilds_operat('cand_type_setting', 'show')) { ?>
                    <div class="col-md-6 col-xs-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="select-generat form-control"  data-allow-clear="true" name="cand_type" data-placeholder="Select Option" <?php echo nokri_feilds_operat('cand_type_setting', 'required'); ?>>
                ...
                <?php } if (nokri_feilds_operat('cand_about_setting', 'show')) { ?>
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <p class="control-label">Give a description of yourself and what you're all about. This is your first impression to potential employers!</p>
                            <textarea  name="cand_intro" data-parsley-error-message="<?php echo esc_html__('Feild is required', 'nokri'); ?>" class="form-control" cols="30" rows="10" <?php echo nokri_feilds_operat('cand_about_setting', 'required'); ?>><?php echo nokri_candidate_user_meta('_cand_intro'); ?></textarea>
                        </div>
                    </div>
                <?php } ?>
    ...
    <?php if ($skill_sec) { ?> 
        <div class="main-body">
            <div class="dashboard-edit-profile skills">
                 <div class="dashboard-title bottom-margin">
                     <h4><?php echo esc_html__( 'I Have Experience In...', 'nokri' ); ?></h4>
                     <p><?php echo esc_html__( 'Select all that apply', 'nokri' ); ?></p>
                </div>
                <div class="rows">
                                    ...
                                    if (isset($cand_skills_values) && is_array($cand_skills_values)) {
                                        if (array_key_exists($key, $cand_skills_values)) {
                                            ...
                                            <div class="row group">
                                                ...
                                                <div style="display:none;" class="col-md-5 col-sm-5 col-xs-12">
                                                    <div class="form-group"> 
                                                        <label class=""><?php echo nokri_feilds_label('cand_skills_value_plc', esc_html__('Enter Your Skill Value', 'nokri')); ?></label>
                                                        <input class="form-control" type="text" name="cand_skills_val[]" data-parsley-error-message="<?php echo esc_html__('', 'nokri'); ?>" placeholder="<?php echo nokri_feilds_label('cand_skills_value_plc', esc_html__('Digits allowed less than 100', 'nokri')); ?>" value="<?php echo ($skill_lavel); ?>">
                                                    </div></div>
                        ...
                        <div class="row group">
                            ...
                            <div style="display:none;" class="col-md-5 col-sm-5 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="cand_skills_val[]" data-parsley-error-message="<?php echo esc_html__('Digits allowed less than 100', 'nokri'); ?>" placeholder="<?php echo nokri_feilds_label('cand_skills_value_plc', esc_html__('Digits allowed less than 100', 'nokri')); ?>">
                                </div></div>
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <button type="button" class="btnRemove">
                                    <i class="fa fa-close"></i>
    ...
    <!-- Candidate Skills End --> 
        ...
        <div class="main-body">
            <div class="dashboard-edit-profile for-pros">
                <div class="dashboard-title bottom-margin">
                    <h4><?php echo esc_html__( 'Work History', 'nokri' ); ?></h4>
                </div>
                <div class="row">
                    <?php
                    ...
                    if ($cand_profession) {
                        ...
                        foreach ($cand_profession as $profession) {
                            ...
                            $project_detail = (isset($profession['project_desc']) ) ? esc_html($profession['project_desc']) : '';
                            ...
                            <div class="ad-more-box-single <?php echo esc_attr($removeClass); ?>">
                                <?php if ($c > 1) { ?>
                                    <div class="col-md-12 col-sm-12"><h4 class="dashboard-heading"><?php echo nokri_feilds_label('cand_exper_add_new', esc_html__('Additional Work History', 'nokri')) . " " . esc_html($counter); ?></h4></div>
                                <?php } ?>
                                ...
                                <?php } if (nokri_feilds_operat('cand_exper_desc', 'show')) { ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="6" <?php echo nokri_feilds_operat('cand_exper_desc', 'required'); ?> class="form-control"  name="cand_profession['project_desc'][]" placeholder="<?php echo esc_html__('Ex: Stanley, Idaho', 'nokri'); ?>"><?php echo ($project_detail); ?></textarea>
                                        </div>
                                    </div>
                                <?php } echo "" . $removeBtn; ?>
                            </div>
    ...
    <?php } ?>
        <!-- End Candidate Professions-->
                ...
                <div class="col-md-12 col-xs-12 col-sm-12 save-profile">
                    <input type="submit"  value="<?php echo nokri_feilds_label('cand_about_btn', esc_html__('Save Profile', 'nokri')); ?>" class="bluebutton n-btn-flat cand_person_save">
                    <input type="button" disabled  value="<?php echo esc_html__('Processing...', 'nokri'); ?>" class="bluebutton n-btn-flat cand_person_pro"> 
                </div>
            </div>
        </div>
    </div>
    <!-- End Candidate Required Informations -->
    
        <!-- Candidate Additional Informations -->
    <div class="main-body">
        <div class="dashboard-edit-profile">
            
            <div class="dashboard-title bottom-margin">
                <h4><?php echo esc_html__( 'Additional Information', 'nokri' ); ?></h4>
                <p>This additional information is optional to enhance your resume.</p>
            </div>
            ...
            <div class="dashboard-social-links">
                ...
                <?php } if (nokri_feilds_operat('cand_cover_setting', 'show')) { ?>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class=""><?php echo nokri_feilds_label('cand_cover_label', esc_html__('Cover Image', 'nokri')); ?></label>
                ...
                <?php } if (nokri_feilds_operat('cand_quali_setting', 'show')) { ?>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="select-generat form-control" data-allow-clear="true" data-placeholder="Select Option" id="change_term" name="cand_qualification" <?php echo nokri_feilds_operat('cand_quali_setting', 'required'); ?>>
                                <option value=""><?php echo esc_html__('Select Option', 'nokri'); ?>
                ...
                <?php } if (nokri_feilds_operat('cand_salary_range_setting', 'show')) {
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="select-generat form-control" data-allow-clear="true" data-placeholder="Select Option" name="cand_salary" <?php echo nokri_feilds_operat('cand_salary_range_setting', 'required'); ?>>
                                <option value=""><?php echo esc_html__('Select Option', 'nokri'); ?><?php echo nokri_job_post_taxonomies('job_salary', $cand_salary_range); ?>
                            </select>
                        </div>
                    </div>
                <?php } if (nokri_feilds_operat('cand_salary_curren_setting', 'show')) {
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="select-generat form-control" data-allow-clear="true" data-placeholder="Select Option" name="cand_salary_currency" id="change_term" <?php echo nokri_feilds_operat('cand_salary_curren_setting', 'required'); ?>>
                                <option value=""><?php echo esc_html__('Select Option', 'nokri'); ?>
                ...
                <?php } if ($custom_feilds_html != '') { ?>
                
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="row">
                            <?php echo $custom_feilds_html; ?> 

                        </div>
                    </div>
                <?php } ?>
                <!-- Candidate Availability -->
        <div class="col-md-12 col-xs-12 col-sm-12 top-padding">
            <div class="row">
                <div class="dashboard-title bottom-margin">
                    <h4><?php echo esc_html__( 'Availablility', 'nokri' ); ?></h4>
                    <p>This helps employers know how long you are planning to stay.</p>
                </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <div class="form-group ">
                                <label class="end-hide">Start & End Date</label>
                                <input type="text" value="<?php echo bt_change_date_format( $cand_availability ); ?>" name="cand_availability" placeholder="Start Date" class="bt-datepicker-canidate form-control" readonly="readonly" data-date-input="end-date-9">                                     
                            </div>
                        </div>
                    </div>
                    <!--<div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <div class="form-group ">
                                <label class="end-hide">End Date</label>
                                <input type="text" value="<?php echo $cand_availability_end; ?>" name="cand_availability_end" placeholder="End Date" class="datepicker-here-canidate form-control end-hide date-end" readonly="readonly" data-date-input="end-date-10">                                     
                            </div>
                        </div>
                    </div>-->
            </div>
                    ...
                    <?php if (nokri_feilds_operat('cand_resumes_setting', 'show')) { ?> 
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <label><?php echo esc_html__('Upload Resume', 'nokri' ); ?></label>
                    <p class="control-label"><?php echo esc_html__('Drag, drop or click to upload resume. This will automatically upload when you apply to jobs.', 'nokri' ); ?></p>
                              
                                <div id="dropzone_resume" class="dropzone"></div> 
                            </div>
                        </div>
                    <?php } if ($cand_video_resume_switch) { ?>
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <div class="form-group">
                                <label class="control-label">
                                    <?php echo nokri_feilds_label('cand_resume_label', esc_html__('   Upload Reusmes Video', 'nokri')); ?>
                                </label>
                                <div id="ad_vidoe_dropzone" class="dropzone"></div> 
                                <input type="hidden"  id="video_logo_url" value="<?php echo trailingslashit(get_template_directory_uri()) . 'images/video-player.png'; ?>">
                            </div>
                        </div>


                    <?php } else if (nokri_feilds_operat('cand_video_resume_setting', 'show')) { ?>
            ...
            <div class="dashboard-edit-profile for-edus">
                ...
                <div class="row">
                    ...
                    <div class="ad_more_box"> 
                        ...
                        <div class="input-group-btn ad-more-btn">
                            <button class="outlinebluebutton n-btn-flat btn-success" type="button" onclick="return education_fields();"> <i class="fa fa-plus" aria-hidden="true"></i>
    ...
    <!-- End Candidate Additional Information Informations -->
            ...
            <div class="dashboard-edit-profile for-cert">
                ...
                <div class="row">
                    ...
                    foreach ($cand_certifications as $certification) {
                        ...
                        <div class="ad-more-box-single <?php echo esc_attr($removeClass); ?>">
                            <?php if ($cert > 1) { ?>
                                <div class="col-md-12 col-sm-12"><h4 class="dashboard-heading"><?php
                                        echo nokri_feilds_label('cand_exper_add_new', esc_html__('Certification Additional Field', 'nokri')) . " " . esc_html($counter);
                                        ;
                                        ?></h4></div>
                            <?php } ?>
        ...
        <div class="main-body">
            <div class="dashboard-edit-profile">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <?php if (nokri_feilds_operat('cand_portfolio_setting', 'show')) { ?>
                                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label"><?php echo nokri_feilds_label('portfolio_section_label', esc_html__('Photos for your Projects', 'nokri')); ?></label>
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <input type="submit" value="<?php echo nokri_feilds_label('cand_portfolio_btn', esc_html__('Save Portfolio', 'nokri')); ?>" class="btn n-btn-flat">
                    </div>
                </div>
            </div>
        </div>
        <!-- End Candidate Portfolio -->
    <?php } if ($custom_feilds_cand != '') { ?>
        <!-- Candidate Custom Feilds -->
        <div class="main-body">
            <div class="dashboard-edit-profile">
                 <div class="dashboard-title bottom-margin">
                    <h4><?php echo esc_html__( 'Seasonal Specific', 'nokri' ); ?></h4>
                    <p>This additional information will make your profile complete.</p>
                </div>
                <div class="dashboard-social-links">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="row">
                            <?php echo $custom_feilds_cand; ?> 
    ...
    <?php } if ($soc_sec) { ?>
        ...
        <div class="main-body">
            <div class="dashboard-edit-profile">
                <div class="dashboard-title bottom-margin">
                    <h4><?php echo esc_html__( 'Connect Your Linkedin', 'nokri' ); ?></h4>
                    <p>Link your account directly to your profile for the best results.</p>
                </div>
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="dashboard-social-links">
    ...
    if ($hours_sec) {
        ...
        if (!empty(nokri_fetch_business_hours($user_crnt_id))) {
            $days = nokri_fetch_business_hours($user_crnt_id);
        } else {
            $dayss = nokri_week_days();
        ...
        <div class="main-body">
            <div class="dashboard-edit-profile">
                <h4 class="dashboard-heading"><?php echo nokri_feilds_label('cand_hours_label', esc_html__('Scheduled Hours', 'nokri')); ?></h4>
                <div class="submit-listing-section for-zone l_bhours_dddddform">
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <div class="form-group has-feedback">
                                ...
                                <div class="pull-right <?php echo esc_attr($flip_it); ?>">
                                    <ul class="frontend_hours list-inline">
                                        <li>
                                            <input id="na" class="input-icheck-others"  name="type_hours"  value="0" <?php echo checked(0, $selected_val, false); ?>  type="radio">
                                            <label for="na"><?php echo esc_html__('N/A', 'nokri'); ?></label>
                                        </li>
                                        <li>
                                            <input id="open" class="input-icheck-others"  name="type_hours" value="1" <?php echo checked(1, $selected_val, false); ?>  type="radio">
                                            <label for="open"> <?php echo esc_html__('Available 24/7', 'nokri'); ?></label>
                                        </li>
                                        <li>
                                            <input id="selective" class="input-icheck-others"  name="type_hours" value="2" <?php echo checked(2, $selected_val, false); ?>  type="radio">
                                            <label for="selective"> <?php echo esc_html__('Selective Hours', 'nokri'); ?></label>
                                        </li>
                            ...
                            <div class="form-group <?php echo esc_attr($my_class); ?> my-zones" id="timezone">
                                <label class="control-label"><?php echo esc_html__('Select Time zone', 'nokri') ?></label>
                                                        ...
                                                        <div class="tab-pane fade <?php echo ( $key == 0 ) ? 'in active' : ''; ?>" id="tab1<?php echo esc_attr($key); ?>">
                                                            <div class="row">
                                                                <div class="col-md-5 col-xs-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> <?php echo esc_html__('From', 'nokri'); ?> </label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="ti-time"></i></span>
                                                                            <input type="text" class="for_specific_page form-control timepicker" name="from[]" id="from-<?php echo esc_attr($key); ?>" placeholder="<?php echo esc_html__('Select your business hours', 'nokri'); ?>" value="<?php echo trim(date("g:i A", strtotime($day['start_time']))); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-5 col-xs-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo esc_html__('To', 'nokri'); ?></label>
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"><i class="ti-time"></i></span>
                                                                            <input type="text" class="for_specific_page form-control timepicker" id="to-<?php echo esc_attr($key); ?>" name="to[]" placeholder="<?php echo esc_html__('Select your business hours', 'nokri'); ?>" value="<?php echo trim(date("g:i A", strtotime($day['end_time']))); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 col-xs-12 col-sm-2">
                                                                    <div class="form-group mt45">
                                                                        <label class="control-label"> <?php echo esc_html__('Closed', 'nokri'); ?> </label>
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <input type="submit" value="<?php echo esc_attr__('Save Hours', 'nokri') ?>" class="btn n-btn-flat cand_person_save">
                            <input type="button" disabled="" value="<?php echo esc_attr__('Processing.....', 'nokri') ?>" class="btn n-btn-flat cand_person_pro" style="display: none;">
                        </div>
                    </div>
                </div>   
...
<!-- update password-->  
<div style="display: none;" class="main-body change-password">
    <div class="dashboard-edit-profile">
        <div class="dashboard-title bottom-margin">
        <h4><?php echo esc_html__( 'Update Password', 'nokri' ); ?></h4>
        </div>
        <form id="change_password" method="post" enctype="multipart/form-data">
            <div class="dashboard-social-links">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    ...
                    <input type="button" disabled  value="<?php echo esc_html__('Processing...', 'nokri'); ?>" class="bluebutton n-btn-flat cand_pass_pro">
                    <input type="button" value="<?php echo esc_html__('Delete account?', 'nokri'); ?>" class="outlinebluebutton n-btn-flat btn-custom del_acount"><?php } ?>
                </div>
            </div>
        </form>
    </div>
