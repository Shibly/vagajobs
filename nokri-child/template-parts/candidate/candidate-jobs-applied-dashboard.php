...
<div class="main-body dashboard-title no-bottom-padding" style="padding-top:0px !important">
    <h4><?php echo esc_html__( 'Jobs Applied', 'nokri' ); ?></h4>
</div>

<div class="main-body no-bottom-padding">
    ...
    <div class="row">
        <div class="col-md-5 col-xs-12 col-sm-4">
            <div class="form-group">
                        <form role="search"  id="job_search" method="get" class="form-control searchform ">
                             <input type="hidden" name="candidate-dashboard" value="jobs-applied" >
                            ...
                            <a href="javascript:void(0)" class="a-btn no-top search_aplied_job"><i class="fa fa-search"></i></a>
...
<?php $count++; }  } else { ?>
 <div class="dashboard-posted-jobs">
    <div class="notification-box">
        ...
        <h4><?php echo esc_html__( 'You Have Not Applied To Any Jobs Yet', 'nokri' ); ?></h4>
    </div>
</div>
<?php }  ?>
</div>
