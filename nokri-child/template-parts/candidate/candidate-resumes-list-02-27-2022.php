...
<div class="main-body dashboard-title">
    <h4><?php echo esc_html__( 'My Resumes', 'nokri' ); ?></h4>
</div>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="file-upload-wrapper" data-text="<?php echo esc_html__( "Click to upload","nokri"); ?>">
          		<input name="my_cv_upload[]" type="file" class="form-control file-upload-field upload_resume_tab" data-show-preview="false" data-show-upload="false">
        	  </div>
              </div>
           </div>
          </div>
