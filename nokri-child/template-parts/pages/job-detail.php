<?php global $nokri;
$job_deadline = $job_type = $job_level = $job_shift = $job_experience = $job_skills = $job_seasons = $job_salary = $job_qualifications = $job_currency = $ad_mapLocation = $ad_map_lat  = $post_apply_status =  $ad_map_long = $job_phone = $cats = $project = $web = $company_name = $single_job_badges  = $box_class  = '';
$job_id	=	get_the_ID();
...
$breadcrumb_style = '';
 ...
 ?>
<section class="job-breadcrumb <?php echo esc_attr($breadcrumb_style)." ". esc_attr($breadcrumb_overlay_class)." ". esc_attr($breadcrumb_full); ?>" <?php echo nokri_returnEcho($bg_url); ?>>
            <div class="container">
               <div class="row">
