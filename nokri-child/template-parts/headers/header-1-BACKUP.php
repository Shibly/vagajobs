         ...
         <section class="menu-list-items ">
         	<div class="no-padding full-width container<?php echo esc_attr($dashboard_fluid); ?>">
                <ul id="hamburger-menu" class="menu-logo">
                    <li style="" class="extra-links"><a href="<?php echo home_url(); ?>/employers/">Employers</a></li>
                    <li class="separator extra-links"><span>|</span></li>
                    <li style="" class="extra-links"><a href="<?php echo home_url(); ?>/jobs/">Jobs</a></li>
                </ul>
                ...
                <ul class="menu-button">
                  ...
                  /* User Icon And Button */
                   if((isset($nokri['user_bar_switch'])) && $nokri['user_bar_switch']  == '1' )
                    ...
                    <li class="cart-container"><?php echo do_shortcode("[woo_cart_but]"); ?></li>
                   ...
                   <li>
                   		<a href="<?php echo get_the_permalink($signup); ?>" class="hide-on-mobile n-login-header">Sign Up</a>
                       <a href="<?php echo get_the_permalink($signup); ?>" class="hide-on-desktop n-login-header"><i class="fa fa-user-plus"></i></a>
                   </li>
                   <li>
