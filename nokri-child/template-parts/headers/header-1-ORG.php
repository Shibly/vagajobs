...
if(wp_basename(get_page_template()) == 'page-home.php')
{
	$page_check = true;
}

$bread_class = 'as-breadcrumb';
if(wp_basename(get_page_template()) == $page_check )
{
	$bread_class = '';
}
/* Signin  Page */
...
<div class="transparent-header-1">
 <nav id="menu-1" class="mega-menu <?php echo esc_attr($dashboard_class)." ".$bread_class; ?>">
         <section class="menu-list-items ">
         	<div class="no-padding full-width container<?php echo esc_attr($dashboard_fluid); ?>">
                <ul id="hamburger-menu" class="menu-logo">
                    <li class="extra-links dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Jobs</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo home_url(); ?>/jobs/">Find Jobs</a></li>
                                <li><a href="<?php echo home_url(); ?>/employers/">View Employers</a></li>
                                <li><a href="<?php echo home_url(); ?>/jobs/?job_salary=1256/">Jobs With Housing</a></li>
                                <li><a href="<?php echo home_url(); ?>/howitworks/">How It Works</a></li>
                                <?php
                                if ( is_user_logged_in()) {  ?>
                                <li><a href="<?php echo home_url(); ?>/dashboard/">Dashboard</a></li>
                                <?php }  else { ?>
                                <li><a href="<?php echo home_url(); ?>/account/">Create Your Profile</a></li>
                                <?php } ?>
                            </ul>
                    </li>
                    ...
                    <li class="extra-links dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Find Employees</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo home_url(); ?>/job-post/">Post A Job</a></li>
                                <li><a href="<?php echo home_url(); ?>/howitworks/">How It Works</a></li>
                                <?php
                                if ( is_user_logged_in()) {  ?>
                                <li><a href="<?php echo home_url(); ?>/dashboard/">Dashboard</a></li>
                    ...
                    <li class="extra-links dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Travel Blog</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo home_url(); ?>/blog/category/personal-stories/" target="_blank">Personal Stories</a></li>
                                <li><a href="<?php echo home_url(); ?>/blog/category/seasonal-work/" target="_blank">Seasonal Work</a></li>
                                <li><a href="<?php echo home_url(); ?>/blog/category/travel-tips/" target="_blank">Travel Tips</a></li>
                                <li><a href="<?php echo home_url(); ?>/blog/category/did-you-know/" target="_blank">Did You Know?</a></li>
                                <li><a href="<?php echo home_url(); ?>/blog/category/employer-highlights/" target="_blank">Employer Highlights</a></li>
                                <li><a href="<?php echo home_url(); ?>/blog/category/seasonal-destinations/" target="_blank">Seasonal Destinations</a></li>
                            </ul>
                    </li>
                </ul>
            <ul class="menu-logo-image">
                ...
                <ul class="menu-button">
                  ...
                  /* User Icon And Button */
                   if((isset($nokri['user_bar_switch'])) && $nokri['user_bar_switch']  == '1' )
                    ...
                    <li class="profile-pic dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo esc_url($image_dp_link[0]); ?>" alt="<?php echo esc_attr__("image", "nokri") ?>" class="img-circle" width="36"><span class="hidden-xs hidden-sm"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo get_the_permalink($dashboard_id); ?>"><i class="fa fa-tachometer"></i><?php echo esc_html__('Dashboard','nokri'); ?></a>
                                    </li>
                                    
                                    <li>
                                        <a href="<?php echo home_url(); ?>/account/edit-account/"><i class="fa fa-user"></i><?php echo esc_html__('Account Details','nokri'); ?></a>
                                    </li>
                   ...
                   <?php }  else { ?>
                   <li>
                   		<a href="<?php echo home_url(); ?>/job-post/" class="n-login-header">Post Job</a>
                   </li>
                   <li class="separator extra-links"><span class="n-login-header">|</span></li> 
                   <li>
                   		<a href="<?php echo get_the_permalink($signin); ?>" class="hide-on-mobile n-login-header">Sign In</a>
                       <a href="<?php echo get_the_permalink($signin); ?>" class="hide-on-desktop n-login-header"><i class="fa fa-sign-in"></i></a>
                   </li>
