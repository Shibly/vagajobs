...
/* Getting Job Seasons  */
$job_seasons      = array();
$job_seasons      =  get_post_meta($job_id, '_job_seasons', true);
$season_tags      =  '';
		 ...
		 foreach($taxonomies as $taxonomy)
				{
					...
					$season_tags .= " ".esc_html($taxonomy->name)." ".',';
				}
	  }
}
   ...
   <div class="job-detail-widget">
      ...
      <ul>
         ...
         <li>
          ...
          <li>
            <?php echo esc_html__('Job Seasons :', 'nokri' )." "; ?> <strong><?php echo  rtrim($season_tags, ','); ?></strong>
         </li>
         <li>
