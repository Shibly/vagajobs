...
<div class="posted-job-list" id="all-jobs-list-box2-<?php echo esc_attr($job_id); ?>">
    <ul class="list-inline">
        ...
        <li class="posted-job-action"> 
            <ul class="list-inline">
                <li class="tool-tip" title="<?php echo esc_html__( 'Edit Job', 'nokri' ); ?>"><a href="<?php echo $final_url;  ?>" class="label label-info"> <i class="fa fa-edit"></i></a></li>
                <li class="tool-tip" title="<?php echo esc_html__( 'Delete Job', 'nokri' ); ?>"><a href="javascript:void(0)" data-value="<?php echo esc_attr( $job_id );?>" class="label label-danger del_my_job"><i class="fa fa-trash"></i></a></li>
            </ul>
        </li>
