...
<div class="main-body dashboard-title">
    <h4><?php echo esc_html__( 'Add Your Email Templates', 'nokri' ); ?></h4>
</div>
...
<div class="main-body">
    <div class="dashboard-edit-profile">
        ...
        <input type="hidden" value="<?php echo esc_attr($template_id); ?>" id="template_id" name="template_id" />
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <label class="bottom-padding"><?php echo esc_html__( 'Description', 'nokri' ); ?><span class="required">*</span>
                    </label>
                    <textarea cols="6" rows="8" name="email_temp_details"  class="form-control rich_textarea"><?php echo "".$template_body;?></textarea>
                </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <button class="bluebutton n-btn-flat" id="temp_save"><?php echo esc_html__( 'Save Template', 'nokri' ); ?></button>
                <button class="bluebutton n-btn-flat" type="button" id="temp_proc" disabled><?php echo  esc_html__( 'Processing...','nokri' ); ?></button>
            </div>
        </form>
    </div>
</div>
