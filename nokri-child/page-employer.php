        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <!--Search/Sort-->
                    <div style="visibility: hidden; position: absolute;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 search-refine">
                        <aside class="new-sidebar">
                            <div class="heading">
                                        ...
                                        <a class="clear-button" href="<?php echo get_the_permalink(); ?>"><?php echo esc_html__("Clear All", "nokri"); ?></a>                  
                                                ...
                                                foreach ($users2 as $user) {
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="n-company-grid-single">
                                                            <?php  echo $featured; ?>
                                                            <a href="<?php echo esc_url(get_author_posts_url($user_id)); ?>"><div class="employer-cover-thumb" <?php echo "" . ($bg_url); ?>></div></a>
                                                            <div class="n-company-grid-img">
                                                                <div class="n-company-logo">
                                                                    <a href="<?php echo esc_url(get_author_posts_url($user_id)); ?>"> <div style="background: url(<?php echo esc_url($image_dp_link[0]); ?>);" class="logo-responsive img-responsive" alt="<?php echo esc_attr__('image', 'nokri'); ?>"></div></a>
                                                                </div>
