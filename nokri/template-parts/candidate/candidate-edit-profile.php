    ...
    <?php } if ($prof_sec) { ?>
        ...
        <div class="main-body">
            <div class="dashboard-edit-profile for-pros">
                <h4 class="dashboard-heading"><?php echo nokri_feilds_label('experience_section_label', esc_html__('Job experience', 'nokri')); ?></h4>
                <div class="row">
                    <?php
