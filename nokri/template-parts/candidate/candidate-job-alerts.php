    ...
    <ul class="list-inline">
        ...
        <li class="posted-job-title">
            <div class="posted-job-title-meta    <?php echo esc_attr($expire_class) ?>">
                ...
                <p><?php if($freq !=""){ echo esc_html(nokri_get_candidates_job_alerts_freq($freq)); }?></p>
            </div>
        </li>
...
<?php } else { 
 ...
 <div class="dashboard-posted-jobs">
            <div class="notification-box">
                ...
                <a href="javascript:void(0)" class="btn n-btn-flat job_alert"><?php echo esc_html__( 'Subsucribe Now', 'nokri' ); ?> </a>
            </div>
        </div>
<?php }} ?>
