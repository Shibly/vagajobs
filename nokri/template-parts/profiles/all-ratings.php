...
if ($author_id == "" && is_page_template('page-employer-reviews.php')) {
                        ...
                        <div class="review-content-meta">
                            ...
                            <div class="review-date"> <span class="user-profile"> <a href="<?php echo esc_url(get_author_posts_url($get_ratings->comment_post_ID)); ?>">
                                    ...
                                    if ($recomment != '') {
                                        ...
                                        <?php
                                        echo esc_html__('this vendor on', 'nokri');
                                    }
                                    ?>
                            ...
                            <div class="review-reply-messgae">
                                <h5>
                                    ...
                                    if (isset($_GET['tab-data']) && $_GET['tab-data'] == "my_ratings") {
                                        ...
                                        echo esc_html__('Employer Reply:', 'nokri');
                                    }
                                    ?>
                                </h5>
    ...
    if (isset($_GET['tab-data']) && $_GET['tab-data'] == "my_ratings") {
        ...
        if ($comment_count > $limit) {
            if (isset($_GET["user_id"]) && $_GET["user_id"] != "") {
                ...
                ?>
                <div class="extra-button"> <a href="<?php echo esc_url(get_the_permalink($nokri['employer_reviews'])); ?>?user_id=<?php echo esc_attr($author_id); ?>" class="btn n-btn-flat btn-block">
