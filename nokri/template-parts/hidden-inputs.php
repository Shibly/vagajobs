...
<input type="hidden" id="nokri_cover_save" value="<?php echo esc_html__( 'Cover picture updated successfully ', 'nokri' ); ?>" />
...
<input type="hidden" id="not_emp" value="<?php echo esc_html__( 'Employers can perform this', 'nokri' ); ?>" />
