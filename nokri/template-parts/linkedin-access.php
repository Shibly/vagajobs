...
if(isset($_GET['code']))
{
	...
	if(count($response) > 0)
	{
		...
		{	
			...
			{
				$res	=	nokri_check_social_user_linkedin( '5868', $email, $fname . ' ' . $lname, $headline, $publicProfileUrl );
