...
function nokri_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
         ...
         array(
            'name' => esc_html__('Nokri Elementor Widgets', 'nokri'),
            'slug' => 'nokri-elementor',
            'source' => get_template_directory_uri() . '/required-plugins/nokri-elementor.zip',
            'required' => true,
            'version' => '1.0.4',
            'force_activation' => false,
            'force_deactivation' => false,
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => 'https://downloads.wordpress.org/plugin/contact-form-7.5.2.2.zip',
            'is_callable' => ''
        ),	
		array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => 'https://downloads.wordpress.org/plugin/post-views-counter.1.3.2.1.zip',
            'is_callable' => ''
        ),
		...
		array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => 'https://downloads.wordpress.org/plugin/add-to-any.1.7.42.zip',
            'is_callable' => ''
        ),
		array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => 'https://downloads.wordpress.org/plugin/one-click-demo-import.2.6.1.zip',
            'is_callable' => ''
        ),
		...
		array(
			...
			'external_url'       => esc_url( 'https://downloads.wordpress.org/plugin/woocommerce.4.6.0.zip'
