    ...
    class jobs {
        ...
        function nokri_search_layout_list_1($pid, $col = '', $sm = 6, $holder = '') {
            ...
            if ($job_bookmark == '') {
             ...
             $company_name   = get_the_author_meta('display_name', $post_author_id)."    ";
             $company_name   =  '<a href="'. esc_url($company_url).'" class="" >'.$company_name.'</a>';
                                       ...
                                       <div class="n-featured-single">
                                          <div class="n-featured-single-top">
                                             ...
                                             <div class="n-featured-singel-meta">
                                                ...
                                                <p><i class="fa fa-user"></i>'.$company_name.'<i class="fa fa-map-marker"></i>'. nokri_job_country($pid, '') . '</p>
												' . $job_badge_ul . '
                                             </div>
											 ' . $featured_html . '
                                          </div>
        ...
        function nokri_search_layout_list_2($pid, $col = '', $sm = 6, $holder = '') {
            ...
            return $my_ads = '<li>
                                    <div class="vertical-single-job ">
                                       ...
                                       <h4><a href="' . get_the_permalink($pid) . '">' . get_the_title($pid) . '</a></h4>                                              
                                       <p><i class="fa fa-user"></i><a href="'.esc_url($company_url).'">' . " " .$company_name. '</a></p>
        ...
        function nokri_search_layout_list_3($pid, $col = '', $sm = 6, $holder = '') {
            ...
            $job_type = wp_get_post_terms($pid, 'job_type', array("fields" => "ids"));
            $job_type = isset($job_type[0]) ? $job_type[0] : '';
            $job_shift = wp_get_post_terms($pid, 'job_shift', array("fields" => "ids"));
            $job_shift = isset($job_shift[0]) ? $job_shift[0] : '';
            $job_salary = wp_get_post_terms($pid, 'job_salary', array("fields" => "ids"));
            $job_salary = isset($job_salary[0]) ? $job_salary[0] : '';
            $job_level = wp_get_post_terms($pid, 'job_level', array("fields" => "ids"));
            ...
            if ($rel_image_link[0] != '') {
                $comp_img_html = '<div class="n-featured-singel-img">
                                                <a href="'. esc_url($company_url).'"><img src="' . esc_url($rel_image_link[0]) . '" class="img-responsive" alt="' . esc_attr__('logo', 'nokri') . '"></a>
                                             </div>';
            }
            /* save job */
            if (is_user_logged_in()) {
            ...
            $format_location = get_post_meta($pid, 'job_format_location', true);
            if ($last_location == '') {

                $last_location = '<a href="">' . $format_location. '</a>';
            }
            ...
            return $my_ads = '<div class="job-search-loop n-job-single ' . esc_attr($premium_class) . '">
                                    ...
                                    ' . $comp_img_html . '
                                       <ul class="list-inline">
                                          <li class="n-job-title-box">
                                             ...
                                             <p>
											 <span><i class="fa fa-map-marker"></i>' . " " . $last_location . '</span>
											 </p>
											 ' . ($job_badge_text) . '
                                          </li>
                                          <li class="n-job-short">
                                            <span class="tooltip">
                                                ...
                                                <span class="tooltiptext"><p>Season For Hire</p>'. nokri_job_post_single_taxonomies('job_type', $job_type) . '</span>
                                            </span>
                                            
                                            <span class="tooltip">
                                                <i class="fa fa-clock-o"></i>
                                                <span class="tooltiptext"><p>Job Type</p>'. nokri_job_post_single_taxonomies('job_shift', $job_shift) . '</span>
                                            </span>
                                            
                                            <span class="tooltip">
                                                <i class="fa fa-lock"></i>
                                                <span class="tooltiptext"><p>Minimum Age</p>'. nokri_job_post_single_taxonomies('job_level', $job_level) . '</span>
                                            </span>
                                            
                                            <span class="tooltip">
                                                <i class="fa fa-thermometer-half"></i>
                                                <span class="tooltiptext"><p>Minimum Experience</p>'. nokri_job_post_single_taxonomies('job_experience', $job_experience) . '</span>
                                            </span>
                    
                                          </li>
                                          <li class="n-job-btns">
                                          <a href="' . get_the_permalink($pid) . '" class="whitebutton n-btn-flat btn-mid btn-clear">View Job</a>
                                            ' . $exter_apply_btn . '
                                          </li>
                                       </ul>
                                    </div>
