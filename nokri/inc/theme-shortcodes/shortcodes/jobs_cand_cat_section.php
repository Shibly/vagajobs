    ...
    function jobs_cand_cat_section_short_base_func($atts, $content = '') {
        ...
        if ($job_class_slider->have_posts()) {
            ...
            while ($job_class_slider->have_posts()) {
                ...
                if ($job_bookmark == '') {
                    $save_job = '<a href="javascript:void(0)" class="n-fav-icon save_job" data-value = "' . $job_id . '"> <i class="ti-heart"></i></a>';
                } else {
        ...
        if (!empty($authors)) {
            foreach ($authors as $author) {
                ...
                $required_user_html .= '<div class="item">
									...
									<div class="n-candidate-lcation">	<a href="#"><i class="fa fa-map-marker"></i>Australia</a>
									</div>
